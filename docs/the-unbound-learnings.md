...
- **Right-grid badges (2026-06):** TIC draws 8×8 pill sprites per action cell; `CELL_GAP_PX = 4`; combat `enemyArmy` deltas anchor to Fight badge via `deltaAnchorsByTarget`. Preview plates retired.
